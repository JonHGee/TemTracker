...
class LayerTest:JFrame() {
    ...
    init {
        EventQueue.invokeLater {
            ...
            val con = Config()
            con.setBounds(size.width/4, size.height/2,
                300, 150);
...
//            g2d.fillRect(0, 0, getWidth(), getHeight());
    ...
    inner class Config : JPanel() {
        ...
        init {
            ...
            this.add(counterText2)
            add(sizeset)

            // val counter = JLabel("82")


            configButton.addActionListener { exitProcess(0) }
